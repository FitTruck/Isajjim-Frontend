...
// 로컬 PLY 서버 URL (python3 cors_server.py)
// 정렬된 PLY 사용 (aligned 폴더)
const PLY_BASE_URL = 'http://localhost:8082/aligned';
...
const ALL_FURNITURE: SimulationFurniture[] = [
  // BED 타입들
  {
    ...
    height: 500,
    volume: 1.0,
    ply_url: `${PLY_BASE_URL}/1_BED_6.ply`,
  },
  {
    furnitureId: 2,
    label: 'BED',
    ...
    height: 500,
    volume: 1.0,
    ply_url: `${PLY_BASE_URL}/2_BED_1.ply`,
  },
  {
    furnitureId: 3,
    label: 'BED',
    ...
    height: 500,
    volume: 1.0,
    ply_url: `${PLY_BASE_URL}/5_BED_0.ply`,
  },
  {
    furnitureId: 4,
    label: 'BED',
    ...
    height: 500,
    volume: 1.0,
    ply_url: `${PLY_BASE_URL}/6_BED_0.ply`,
  },
  {
    furnitureId: 5,
    label: 'BED',
    ...
    height: 500,
    volume: 1.0,
    ply_url: `${PLY_BASE_URL}/8_BED_0.ply`,
  },
  {
    furnitureId: 6,
    label: 'BED',
    ...
    height: 500,
    volume: 1.0,
    ply_url: `${PLY_BASE_URL}/9_BED_0.ply`,
  },
  {
    furnitureId: 7,
    label: 'BED',
    ...
    height: 500,
    volume: 1.0,
    ply_url: `${PLY_BASE_URL}/10_BED_2.ply`,
  },
  {
    furnitureId: 8,
    label: 'BED',
    ...
    height: 500,
    volume: 1.0,
    ply_url: `${PLY_BASE_URL}/11_BED_0.ply`,
  },
  // SOFA 타입들
  {
    furnitureId: 9,
    ...
    height: 850,
    volume: 1.68,
    ply_url: `${PLY_BASE_URL}/9_SOFA_1.ply`,
  },
  {
    furnitureId: 10,
    label: 'SOFA',
    ...
    height: 850,
    volume: 1.68,
    ply_url: `${PLY_BASE_URL}/12_SOFA_0.ply`,
  },
  // NIGHTSTAND
  {
    furnitureId: 11,
    ...
    height: 550,
    volume: 0.11,
    ply_url: `${PLY_BASE_URL}/2_NIGHTSTAND_0.ply`,
  },
  {
    furnitureId: 12,
    label: 'NIGHTSTAND',
    ...
    height: 550,
    volume: 0.11,
    ply_url: `${PLY_BASE_URL}/10_NIGHTSTAND_0.ply`,
  },
  // COFFEE_TABLE
  {
    furnitureId: 13,
    ...
    height: 450,
    volume: 0.32,
    ply_url: `${PLY_BASE_URL}/4_COFFEE_TABLE_1.ply`,
  },
  {
    furnitureId: 14,
    label: 'COFFEE_TABLE',
    ...
    height: 450,
    volume: 0.32,
    ply_url: `${PLY_BASE_URL}/11_COFFEE_TABLE_1.ply`,
  },
  // CABINET
  {
    furnitureId: 15,
    ...
    height: 1800,
    volume: 0.65,
    ply_url: `${PLY_BASE_URL}/8_CABINET_1.ply`,
  },
  // CHAIR_STOOL
  {
    furnitureId: 16,
    ...
    height: 850,
    volume: 0.17,
    ply_url: `${PLY_BASE_URL}/4_CHAIR_STOOL_3.ply`,
  },
  // MONITOR_TV
  {
    furnitureId: 17,
    ...
    height: 700,
    volume: 0.08,
    ply_url: `${PLY_BASE_URL}/2_MONITOR_TV_3.ply`,
  },
  // POTTED_PLANT
  {
    furnitureId: 18,
    ...
    height: 600,
    volume: 0.1,
    ply_url: `${PLY_BASE_URL}/2_POTTED_PLANT_2.ply`,
  },
  {
    furnitureId: 19,
    label: 'PLANT',
    ...
    height: 600,
    volume: 0.1,
    ply_url: `${PLY_BASE_URL}/2_POTTED_PLANT_4.ply`,
  },
];
